...
public class AmazonClient {
 ...
 public String uploadFile(MultipartFile multipartFile) {
     ...
     try {
         ...
         //fileUrl is what we return so we know how to get back to the picture that we posted
 ...
 /*
  * this method puts an file into our bucket. 
  * .withCannedAcl is setting the access to Public Read so everyone can view it
  */
